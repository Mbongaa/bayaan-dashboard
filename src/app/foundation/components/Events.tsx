...
import { LoggedEvent } from "@/app/shared/types/types";
  ...
  return (
    <div
      className={
        ...
        " transition-all duration-200 ease-in-out flex-col"
      }
      ref={eventLogsContainerRef}
    >
      {isExpanded && (
        <div>
          <div className="flex items-center justify-between px-6 py-3.5 sticky top-0 z-10 text-base">
            <span className="font-semibold text-gray-900 dark:text-gray-100">Logs</span>
          </div>
          <div>
